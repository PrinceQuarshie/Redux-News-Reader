...
`);
    ...
    8: [
      function (require, module, exports) {
        ...
        function CommentForm(_ref) {
          ...
          var isCreatePending = (0, _reactRedux.useSelector)(
            _commentsSlice.createCommentIsPending
          );
          ...
          var handleSubmit = function handleSubmit(e) {
            ...
            dispatch(
              (0, _commentsSlice.postCommentForArticleId)({
                articleId: articleId,
                comment: comment,
              })
            );
    ...
    14: [
      function (require, module, exports) {
        ...
        var postCommentForArticleId = (0, _toolkit.createAsyncThunk)(
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        _context2.next = 4;
                        return fetch(
                          "api/articles/".concat(articleId, "/comments"),
                          {
                            method: "POST",
                            body: requestBody,
                          }
        ...
        var commentsSlice = (0, _toolkit.createSlice)({
          ...
          extraReducers:
            ...
            _defineProperty(
              _extraReducers,
              postCommentForArticleId.pending,
              function (state, action) {
            ...
            _defineProperty(
              _extraReducers,
              postCommentForArticleId.rejected,
              function (state, action) {
                state.createCommentIsPending = false;
